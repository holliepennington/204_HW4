...
d_quad_model <- lm(damages ~ warming + I(damages^2), data = damages_df)
```

```{r}
#plotting scatterplot for damages
ggplot(data = damages_df, aes(x = damages, y = warming)) + 
  geom_point() + 


#add function to graph still 
```
