...
```{r}
#create plot 
ggplot(warming_df, aes(year, warming_baseline)) + 
  geom_point() + 
  geom_line(aes(d_quad_model))
...
```{r}
#subtract damages_pulse - damages_baseline
#mutate 
#this is damages of additional pulse over time 
```
...
```{r}
#do a conversion from 35billion tons to 1tons for $damages/tonCO2
```
